                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="select-therapists" class="col-5 text-right">Select Department:</label>
                            <div class="col-7">
                                <select class="form-control form-control-sm" id="select-therapists"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-7"><input class="form-control form-control-sm" id="location"
                                    name="location" value="{{ $ticket->location }}"></div>
                        </div>
                        <div class="form-group row">
