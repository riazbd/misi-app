...
@section('content_top_nav_left')
    <div class="ml-5 d-flex align-items-center">
        <h6 class="m-0">No Approval Ticket - {{ $ticket->id }}</h6>
    </div>
@stop
...
@section('content')
    ...
    <div class="p-5">
        ...
        <div class="">
            <form method="POST" action="{{ route('update-no-approval-ticket', ['id' => $ticket->id]) }} "
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h6 class="col-2 text-right activity_log_title">Activity Log</h6>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
        ...
        <div id="ticket-history">
            <div class="row">
                <div class="col-md-12">
                    <h6 class="activity_log_title col-2 text-right">Activites</h6>
                </div>
            </div>
