                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="input-group date" id="startTime" data-target-input="nearest">
                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#startTime" id="startTimeInput"/>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="input-group date" id="endTime" data-target-input="nearest">
                                        <input type="text" class="form-control form-control-sm datetimepicker-input" data-target="#endTime" id="endTimeInput"/>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <select name="weeklyoff[]" id="weekoff" class="form-control from-control-sm col-8 selectpicker" multiple>
