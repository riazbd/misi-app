    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6 px-3">
                <form method="POST" action="{{ route('tickets.update', ['ticket' => $ticket->id]) }}" id="create-ticket-form">
                    @csrf
                    <div class="row">
                        <!-- First Column -->
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="strike-history" rows="3" name="strike-history">{{ $ticket->strike_history }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="ticket-history">Ticket History:</label>
                                <textarea class="form-control" id="ticket-history" rows="3" name="ticket-history">{{ $ticket->ticket_history }}</textarea>
                            </div>
                        </div>
                        <!-- Second Column -->
                        <div class="col-md-6">
