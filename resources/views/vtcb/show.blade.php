...
@section('content_top_nav_left')
    <div class="ml-5 d-flex align-items-center">
        <h6 class="m-0">VTCB Ticket - {{ $ticket->id }}</h6>
    </div>
@stop
...
@section('content')
    ...
    <div class="content-container">
        ...
        <div class="">
            <form method="POST" action="{{ route('update-vtcb-ticket', ['id' => $ticket->id]) }} " id="update-ticket-form"
        ...
        <div id="ticket-history">
            <div class="row">
                <div class="col-md-12">
                    <h6 class=" col-2 text-right ticket_history_title">Activites</h6>
                </div>
            </div>
