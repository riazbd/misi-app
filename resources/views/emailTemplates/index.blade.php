...
@section('content')
    ...
    <div class="pt-5">
        ...
        <div class="mt-2 datatable-container">
            <x-adminlte-datatable id="templateTable" :heads="$heads" striped hoverable bordered with-buttons beautify
                with-footer>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#templateTable tfoot th').each(function(index) {
                if (index != 0) {
                    var title = $(this).text();
            ...
            $('#templateTable th').css('text-align', 'center');
