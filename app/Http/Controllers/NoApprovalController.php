    ...
    public function index()
    {
        ...
        foreach ($tickets as $ticket) {
            ...
            array_push($items, '<nobr>
                    </a><a class="btn btn-xs btn-default text-danger mx-1 shadow" href="' . route('no-approvals.destroy', ['no-approval' => $ticket->id]) . '">
                        <i class="fa fa-lg fa-fw fa-trash"></i>
                    </a><a class="btn btn-xs btn-default text-teal mx-1 shadow" href="' . route('no-approvals.show', ['no-approval' => $ticket->id]) . '">
